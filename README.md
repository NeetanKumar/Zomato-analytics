...
Log in with your phone/OTP when the browser opens, then press Enter. That's
it — `run.py` fetches your orders and writes `order_summary.md` and
`summary.csv`.

Need to run a step on its own? `login.py` → `fetch_orders.py` →
